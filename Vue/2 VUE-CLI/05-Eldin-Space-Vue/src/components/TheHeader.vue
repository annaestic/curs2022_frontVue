  ...
  <div>
    <v-navigation-drawer v-model="drawer" absolute temporary app width="150" height="340">
      <v-list class="pt-4">
        ...
        <v-list-tile active-class="green--text" to="/resume">
          <v-list-tile-content>
            <v-list-tile-title>RESUMEN</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
        <v-list-tile active-class="green--text" to="/services">
          ...
          <v-list-tile-content>
            <v-list-tile-title>ANNA</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
        <v-list-tile active-class="green--text" to="/blog">
          <v-list-tile-content>
    ...
    <v-toolbar flat dense color="transparent" scroll-off-screen>
      ...
      <v-toolbar-items class="hidden-sm-and-down">
        ...
        <v-btn flat to="/anna" active-class="green--text headline">Anna</v-btn>
        <v-btn flat to="/anna" active-class="green--text headline">Anna2</v-btn>
