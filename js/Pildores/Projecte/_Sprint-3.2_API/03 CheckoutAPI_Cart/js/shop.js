...
const fetchData = async () => {
 ...
 async function postCart() {
    ...
    console.log("entra");
   // en el objeto “datos” tenemos los productos del carrito que vamos a enviar al servidor
   datos=cart;
    ...
    var response = await fetch('http://localhost:3000/cart', init);            
    if (response) {          
        window.location="checkout.html?&idcart=1" ; 
        //document.close();
    }else{
 ...
 /*   const response = await fetch('http://localhost:3000/cart', {
    ...
    alert("La media es: " + responseText);
